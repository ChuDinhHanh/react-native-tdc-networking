...
import { ADD_QUESTION_SCREEN, APPLICATION_OPTION_SCREEN, BUSINESS_DASHBOARD_SCREEN, BUSINESS_REGISTER_SCREEN, CONVERSATION_SCREEN, CREATE_NORMAL_POST_SCREEN, CREATE_RECRUITMENT_SCREEN, CREATE_SURVEY_SCREEN, DETAIL_JOB_APPLY, FACULTY_DASHBOARD_SCREEN, FOLLOWING_SCREEN, IMAGE_VIEW_SCREEN, INTERMEDIATELY_SCREEN, JOB_APPLY_SCREEN, LIST_FOLLOW_SCREEN, LIST_JOB_APPLY_SCREEN, LIST_POST_SAVED_SCREEN, LOGIN_SCREEN, MESSENGER_SCREEN, NOTIFICATION_SCREEN, OPTION_SCREEN, PROFILE_SCREEN, RECRUITMENT_DETAIL_SCREEN, REVIEW_SURVEY_POST_SCREEN, SEARCH_SCREEN, SPLASH_SCREEN, STUDENT_DISCUSSION_DASHBOARD_SCREEN, STUDENT_REGISTER_SCREEN, SURVEY_CONDUCT_SCREEN, SURVEY_RESULT_SCREEN, TOP_TAB_NAVIGATOR } from './constants/Screen';
...
function TopTabNavigator(): JSX.Element {
  return (
    ...
    >
      ...
      <TopTab.Screen name={STUDENT_DISCUSSION_DASHBOARD_SCREEN} component={BusinessDashboardScreen} />
      <TopTab.Screen name={NOTIFICATION_SCREEN} component={BusinessDashboardScreen} />
      <TopTab.Screen name={FOLLOWING_SCREEN} component={BusinessDashboardScreen} />
    </TopTab.Navigator>
  )
}
